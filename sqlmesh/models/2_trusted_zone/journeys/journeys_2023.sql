...
@create_index(@this_model, _id, index_name='journeys_2023_id_index');
@create_index(@this_model, start_datetime_tz, index_name='journeys_2023_start_datetime_tz_index');
@create_index(@this_model, start_h3_index, index_name='journeys_2023_start_h3_index_index');
@create_index(@this_model, end_h3_index, index_name='journeys_2023_end_h3_index_index');