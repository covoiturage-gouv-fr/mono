...
journeys AS (
  SELECT
    ...
    h3_latlng_to_cell((ST_SetSRID(ST_Point(j.start_position_x, j.start_position_y), 4326))::point, 9) AS start_h3_index,
    ...
    h3_latlng_to_cell((ST_SetSRID(ST_Point(j.end_position_x, j.end_position_y), 4326))::point, 9) AS end_h3_index,
