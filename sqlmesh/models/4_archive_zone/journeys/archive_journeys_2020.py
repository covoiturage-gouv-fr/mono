...
def execute(context: ExecutionContext, **kwargs):
    ...
    query = build_select_query(COLUMNS_TYPES, "archive_zone.carpools_to_journeys_2020")
    output_file = "/tmp/journeys_2020.parquet"
    file_format = "parquet"
    chunksize = 100_000  
    ...
    upload_info = upload_to_s3(
        ...
        key=f"exports/journeys_2020.{file_format.lower()}",
    )
