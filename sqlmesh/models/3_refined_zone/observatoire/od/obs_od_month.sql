MODEL (
  name refined_zone.obs_od_month,
  ...
  cron '@monthly',
  grain [ 'month_date', 'type', 'territory_1', 'territory_2'],
  tags ['refined', 'observatoire', 'od_month'],
);
...
od_agg AS (
  ...
  -- country
  SELECT
    a.year, a.month, 'country' AS type,
...
@IF(@runtime_stage = 'creating', CREATE UNIQUE INDEX IF NOT EXISTS uq_month_date_type_territory_1_territory_2 ON refined_zone.obs_od_month (month_date, type, territory_1, territory_2));
