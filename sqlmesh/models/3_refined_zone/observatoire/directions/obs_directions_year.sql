...
@IF(@runtime_stage = 'creating', CREATE UNIQUE INDEX IF NOT EXISTS uq_year_date_code_type_direction ON refined_zone.obs_directions_year (year_date, code, type, direction));