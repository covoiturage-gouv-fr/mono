MODEL (
  name refined_zone.obs_directions_users_quarter,
...
@IF(@runtime_stage = 'creating', CREATE UNIQUE INDEX IF NOT EXISTS uq_quarter_date_code_type_direction ON refined_zone.obs_directions_users_quarter (quarter_date, code, type, direction));