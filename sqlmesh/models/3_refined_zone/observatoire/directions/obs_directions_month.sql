...
@IF(@runtime_stage = 'creating', CREATE UNIQUE INDEX IF NOT EXISTS uq_month_date_code_type_direction ON refined_zone.obs_directions_month (month_date, code, type, direction));