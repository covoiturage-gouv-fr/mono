...
@IF(@runtime_stage = 'creating', CREATE UNIQUE INDEX IF NOT EXISTS uq_semester_date_code_type_direction ON refined_zone.obs_directions_semester (semester_date, code, type, direction));